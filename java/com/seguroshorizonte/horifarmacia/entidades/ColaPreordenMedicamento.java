...
@NamedQueries({
    ...
    @NamedQuery(name = "ColaPreordenMedicamento.findByFechaHoy", query = "SELECT COUNT(c) FROM ColaPreordenMedicamento c WHERE c.fecha = :fecha"),
    @NamedQuery(name = "ColaPreordenMedicamento.findByFechaNoHoy", query = "SELECT COUNT(c) FROM ColaPreordenMedicamento c WHERE c.fecha <> :fecha")})
